...
{
    public class EfSystemSettingRepository:EfGenericRepositoryBase<SystemSettingEntity,DatabaseContext>,ISystemSettingRepository
    {
        protected override IQueryable<SystemSettingEntity> BaseGetAll(DatabaseContext context)
        {

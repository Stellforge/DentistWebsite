...
{
    public class EfMessageRepository:EfGenericRepositoryBase<MessageEntity,DatabaseContext>,IMessageRepository
    {
        protected override IQueryable<MessageEntity> BaseGetAll(DatabaseContext context)
        {

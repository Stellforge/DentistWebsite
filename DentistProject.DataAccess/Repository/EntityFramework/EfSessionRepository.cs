...
{
    public class EfSessionRepository:EfGenericRepositoryBase<SessionEntity,DatabaseContext>,ISessionRepository
    {
        protected override IQueryable<SessionEntity> BaseGetAll(DatabaseContext context)
        {

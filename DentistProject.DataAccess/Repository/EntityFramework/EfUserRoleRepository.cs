...
{
    public class EfUserRoleRepository:EfGenericRepositoryBase<UserRoleEntity,DatabaseContext>,IUserRoleRepository
    {
        protected override IQueryable<UserRoleEntity> BaseGetAll(DatabaseContext context)
        {

...
{
    public class EfRoleMethodRepository:EfGenericRepositoryBase<RoleMethodEntity,DatabaseContext>,IRoleMethodRepository
    {
        protected override IQueryable<RoleMethodEntity> BaseGetAll(DatabaseContext context)
        {

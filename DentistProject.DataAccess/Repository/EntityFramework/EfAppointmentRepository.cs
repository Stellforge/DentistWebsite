...
{
    public class EfAppointmentRepository:EfGenericRepositoryBase<AppointmentEntity,DatabaseContext>,IAppointmentRepository
    {
        protected override IQueryable<AppointmentEntity> BaseGetAll(DatabaseContext context)
        {

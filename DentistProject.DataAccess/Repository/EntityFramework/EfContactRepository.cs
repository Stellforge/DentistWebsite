...
{
    public class EfContactRepository:EfGenericRepositoryBase<ContactEntity,DatabaseContext>,IContactRepository
    {
        protected override IQueryable<ContactEntity> BaseGetAll(DatabaseContext context)
        {

...
{
    public class EfIdentityRepository:EfGenericRepositoryBase<IdentityEntity,DatabaseContext>,IIdentityRepository
    {
        protected override IQueryable<IdentityEntity> BaseGetAll(DatabaseContext context)
        {

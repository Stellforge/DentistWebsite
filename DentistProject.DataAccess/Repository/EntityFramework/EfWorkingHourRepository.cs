...
{
    public class EfWorkingHourRepository:EfGenericRepositoryBase<WorkingHourEntity,DatabaseContext>,IWorkingHourRepository
    {
        protected override IQueryable<WorkingHourEntity> BaseGetAll(DatabaseContext context)
        {

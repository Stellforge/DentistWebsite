...
{
    public class EfPatientRepository:EfGenericRepositoryBase<PatientEntity,DatabaseContext>,IPatientRepository
    {
        protected override IQueryable<PatientEntity> BaseGetAll(DatabaseContext context)
        {

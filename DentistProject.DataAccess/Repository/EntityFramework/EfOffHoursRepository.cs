...
{
    public class EfOffHoursRepository:EfGenericRepositoryBase<OffHoursEntity,DatabaseContext>,IOffHoursRepository
    {
        protected override IQueryable<OffHoursEntity> BaseGetAll(DatabaseContext context)
        {
